...
@section('section')
    <section class="container">
        <div class="row my-4">
            <div class="col-12 my-4">
                <p class="text-center h4">Administre las categorías y subcategorías</p>                           
                    ...
                    <p class="text-center">
                        <button class="btn btn-primary m-1" type="button" data-toggle="collapse" data-target="#categoryCollapse" aria-expanded="false" aria-controls="categoryCollapse">Agregar categoría</button>
                        <button class="btn btn-primary m-1" type="button" data-toggle="collapse" data-target="#subCategoryCollapse" aria-expanded="false" aria-controls="subCategoryCollapse">Agregar subcategoría</button>
                    </p>
                    <div class="row">
                        <div class="col-12">
        ...
        <div class="row my-4">
            <div class="col-12 mb-3">
                <p class="text-center h4">Subcategorías registradas</p>
            </div>
            <div class="col-12">
                <table class="table table-sm table-striped table-hover table-borderless">
                    <thead class="text-center">
                    ...
                    <tbody class="text-center">
                        @foreach ($subCategories as $subCategory)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('admin.edit.subCategory',$subCategory->id)}}" class="btn btn-warning my-1"><i class="fa fa-pencil" aria-hidden="true"></i>
                                    <span class="hidden">Editar</span></a>
                                    @if (Auth::user()->autorize(1))
                                        <button  class="btn  btn-danger" data-toggle="modal" data-target="#deleteSub_{{$subCategory->id}}"><i class="fa fa-trash" aria-hidden="true"></i>
                                            <span class="hidden">Eliminar</span></button>
                                        <div class="modal fade" id="deleteSub_{{$subCategory->id}}" tabindex="-1" role="dialog" aria-labelledby="moreDeleteSub{{$subCategory->id}}" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-danger" data-dismiss="modal">Cancelar</button>
                                                    <a href="javascript:document.getElementById('subCategory_{{$subCategory->id}}').submit()" class="btn btn-success">Sí, eliminar</a>
                                                </div>
                                                </div>
                                            </div>
                                        </div>
