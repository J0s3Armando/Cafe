  ...
  <body>
    <header class="bg-light container-fluid ">
      <nav class="navbar navbar-expand-lg  bg-light navbar-light p-1">
        <a class="navbar-brand logo-button" href="{{ route('index')}}"><img class="img-fluid logo rounded-circle" src="{{asset('img/logo/logoMukulum.jpg')}}"  alt=""> Café Mukulum</a>
            ...
            @guest
              ...
              @else
                <li class="nav-item dropdown">
                  <a id="navbarDropdown" class="dropdown-toggle btn btn-block btn-light" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
